...
<Project Type="Project" LVVersion="18008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="NIPKG BuildSpec API.lvlib" Type="Library" URL="../Package Build Specification API (2018)/NIPKG BuildSpec API.lvlib"/>
		<Item Name="Modify Package BuildSpec Version Example.vi" Type="VI" URL="../Modify Package BuildSpec Version Example.vi"/>
		<Item Name="Modify Dependency Package Version in Package BuildSpec Example.vi" Type="VI" URL="../Modify Dependency Package Version in Package BuildSpec Example.vi"/>
